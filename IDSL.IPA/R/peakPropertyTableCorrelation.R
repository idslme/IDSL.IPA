peakPropertyTableCorrelation <- function(peakPropertyTable, RTtolerance = 0.05, minFreqDetection = 1, method = "pearson", minThresholdCorrelation = 0, number_processing_threads = 1) {
  ##
